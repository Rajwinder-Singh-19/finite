...
class TrussElement2D:
    ...
    def element_info(self):
        ...
        print(f"Node 0 x diplacement (m): {self.node_0.x_displacement}\n")
        print(f"Node 0 y displacement (m): {self.node_0.y_displacement}\n")
        print(f"Node 1 x diplacement (m): {self.node_1.x_displacement}\n")
        print(f"Node 1 y displacement (m): {self.node_1.y_displacement}\n")
